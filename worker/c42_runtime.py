...
out={
 ...
 "ROLE":farm.get("domain","physical-prototype-qualification"),
 ...
 "PROVENANCE":{"repository":"dmaillot95-ui/cerebron-farm-65-physical-prototype-qualification","generated_at":datetime.datetime.now(datetime.timezone.utc).isoformat()},
